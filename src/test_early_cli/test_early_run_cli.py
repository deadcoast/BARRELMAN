...
class TestRunCli:
    ...
    def setup_method(self, mock_export_dot_graph, mock_export_markdown, mock_export_html, mock_run_preview_server):
    ...
    def test_highlight_option(self):
        ...
        with mock.patch('sys.argv', test_args), \
             mock.patch('src.cli.BarrelmanLexer.highlight') as mock_highlight, \
    ...
    def test_no_arguments(self):
        ...
        with mock.patch('sys.argv', test_args), \
            ...
            with pytest.raises(SystemExit):
                run_cli()
            assert "the following arguments are required: file" in mock_stderr.getvalue()
