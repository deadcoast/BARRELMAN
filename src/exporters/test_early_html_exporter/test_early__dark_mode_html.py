...
class Token:
    def __init__(self, indent_level, zone_1_declaration, zone_1_relation, zone_2_modifier, zone_3_trigger):
...
class TestDarkModeHtml:
    ...
    def test_dark_mode_with_full_tokens(self, setup_file):
        ...
        assert "<span class='declaration'>    declaration1</span> <span class='relation'>relation1 //</span>" in output
    ...
    def test_light_mode_with_partial_tokens(self, setup_file):
        ...
        assert "<span class='trigger'>-> trigger1</span>" in output
        assert "<span class='declaration'>    declaration2</span> <span class='relation'>relation2 //</span>" in output
    ...
    def test_large_indent_level(self, setup_file):
        ...
        tokens = [
            Token(10, "declaration", "relation", "modifier", "trigger")
        ]
        _dark_mode_html(self.f, True, tokens)
        output = self.f.getvalue()
